// Mostly taken from: https://github.com/lambci/node-custom-lambda/blob/0e3f2133bb2b667fa29aa4adfc30fab22166f6e4/v10.x/bootstrap.js
...
async function start() {
  ...
  await tryProcessEvents(handler)
}
...
function getHandler() {
  const handler = _HANDLER.replace('./', '');
  ...
  // break here once the handler file has been loaded
  debugger;
